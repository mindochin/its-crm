...
class InvoicesFktTmplController extends Controller {
	/**
...
//	public $layout='//layouts/column2';
	...
	public function actionIndex() {
		$dataProvider = new CActiveDataProvider('InvoicesFktTmpl');
	...
	public function actionAdmin() {
		$model = new InvoicesFktTmpl('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['InvoicesFktTmpl']))
			$model->attributes = $_GET['InvoicesFktTmpl'];
	...
	public function loadModel($id) {
		$model = InvoicesFktTmpl::model()->findByPk((int) $id);
		if ($model === null)
	...
	protected function performAjaxValidation($model) {
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'invoices-fkt-tmpl-form') {
